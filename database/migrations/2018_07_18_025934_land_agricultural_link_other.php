...
class LandAgriculturalLinkOther extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
         Schema::create('land_agricultural_link_other', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('land_agricultural_link_other');
    }
}

        ...
        <div class="col-sm-12">
            <table class="tb_grid table table-bordered table-striped" width="100%" id="income_not_agriculture_table">
                ...
                <tr class="myrow_5">
                    ...
                    <td>
                        <div class="form-group">
                            <input id="income_name_not_{{$not}}" name="income_name_not[{{$not}}]" autocomplete="off" class="form-control income_name_not" type="text" value="{{$vl->income_name_not}}" readonly="readonly" required="required">
                        </div>
                        </td>
                    <td>
                        <div class="form-group">
                            <input id="income_age_not_{{$not}}" name="income_age_not[{{$not}}]" autocomplete="off" class="form-control income_age_not" type="text" value="{{$vl->income_age_not}}" readonly="readonly" required="required">
                        </div>
                        </td>
                    <td>
                    ...
                    <td style="text-align:center;">
                        ...
                        @else
                            <a id="other_income_{{$not}}" class="btn btn-sm btn-danger remove_rows_5" onclick="remove_4({{$vl->monthly_income_not}})">
                                <span class="glyphicon glyphicon-minus"></span>
                            </a>
                        @endif
                    </td>
